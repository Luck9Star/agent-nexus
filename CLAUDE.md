...
This project is indexed by GitNexus as **agent-nexus** (7631 symbols, 25704 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
