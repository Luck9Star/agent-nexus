...
This project is indexed by GitNexus as **agent-nexus** (5376 symbols, 16437 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
