...
This project is indexed by GitNexus as **agent-nexus** (8005 symbols, 27400 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
