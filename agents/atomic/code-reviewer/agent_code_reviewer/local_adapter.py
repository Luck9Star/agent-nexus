...
def _handle_analyze(agent: CodeReviewerAgent, params: dict) -> dict:
...
def _handle_check(agent: CodeReviewerAgent, params: dict) -> dict:
    ...
    return {"status": "ok", "result": {"patterns": [p.model_dump() for p in patterns]}}


def _handle_review(agent: CodeReviewerAgent, params: dict) -> dict:
    """Handle the 'review' method."""
