...
ANTI_PATTERNS: list[dict[str, str | re.Pattern[str]]] = [
    ...
    },
    {
        ...
        "severity": "warning",
        "description": "Using non-cryptographic random for potentially security-sensitive operations",
    },
    ...
    },
    {
        ...
        "severity": "info",
        "description": "List comprehension used without storing result; consider generator expression",
    },
    {
        ...
        "severity": "warning",
        "description": "String concatenation in loop; use join() or StringIO for better performance",
    },
    ...
    },
    {
        ...
        "severity": "warning",
        "description": "Deep nesting detected (4+ levels); consider extracting to helper functions",
    },
    {
        "name": "long_function",
        "pattern": re.compile(
        ...
        "severity": "warning",
        "description": "Function is very long (50+ lines); consider breaking into smaller functions",
    },
    {
        "name": "god_class",
        "pattern": re.compile(
    ...
    },
    {
        ...
        "pattern": re.compile(
            r"catch\s*\(\s*Exception\s|except\s+Exception\s*:|except\s*:"
        ),
        "severity": "warning",
